          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <CardContent className="flex items-start flex-col space-y-4">
                ...
                <div className="flex items-center gap-3 rounded-xl border bg-slate-50 p-4 text-sm font-medium">
              ...
              <CardFooter className="pt-0 flex items-center justify-between border-t-0 bg-transparent">
                <div className="flex flex-wrap gap-3">
                  <Button
                    className=" px-4 t shadow-sm transition hover:-translate-y-0.5 hover:shadow-md "
                    onClick={async (e) => {
